 ...
 */
contract Bills is ERC20("BILLS", "BILLS"), Ownable, ReentrancyGuard {
    ...
    */
    function mint(address _to, uint _amount) external nonReentrant {
    ...
    */
    function burn(address _from, uint _amount) external nonReentrant {
        require(managers[msg.sender] == true, "This address is not allowed to interact with the contract");
        _burn(_from, _amount);
    }
}